...
考虑各个服务器的处理能力差异，负载均衡算法又有了对服务器“**加权**”的补充。

加权负载均衡算法增加了按权值高低分配的因素，权值高的服务器会比权值低的服务器处理更多的连接，从而保证服务器集群整体处于均衡状态。常用的加权负载均衡算法有加权轮询均衡（Weight Round Robin）、加权最小连接均衡（Weight Least-Connection）、加权随机均衡（Weight Random）等，笔者就不再一一介绍了。