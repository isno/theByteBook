...
概览以下的里程碑事件，短短两年时间，我们看到 ServiceMesh 从无到有、被社区接受、巨头入局、众人皆捧的过程。
...
那么，什么是 ServiceMesh？《What’s a service mesh？And why do I need one?》，作为 ServiceMesh 的缔造者和布道师，引用 William Morgan 的定义自然是最权威的。
