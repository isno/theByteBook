...
最后，无论是 Sidecarless 还是 Ambient Mesh，它们的设计思路本质是用中心化的代理，替代位于应用容器旁边的 Sidecar 代理。这在一定程度上解决了传统 Sidecar 模式带来的资源消耗、网络延迟问题。但反面是，服务网格的设计理念本来就很抽象，引入 Proxyless、Sidecarless、Ambient Mesh 模式，使得服务网格愈加抽象。笔者相信，大部分工程师直面这些抽象概念，下手解决问题时，一定倒吸口凉气，感觉头皮阵阵发麻。
