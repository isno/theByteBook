...
如果你是一位互联网从业者，我猜出这几年你大概率被这些层出不穷的概念包围：云计算、PaaS、FaaS、CaaS、ServiceMesh、Serverless、AIGC，当然不能遗漏了各种 Ops，诸如 DevOps、GitOps、MLOps、FinOps 等等。

近几年来，软件开发技术经历了翻天覆地的变革，这也直接对构建业务应用产生了重大的影响。在分析那些令人兴奋的技术，以及讨论如何为业务赋能之前，我们先思考一下，引发这一波技术浪潮的核心驱动力是什么？
