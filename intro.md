...
所以，本书很少详细的描述某个软件，而是希望能找到这些变化中的根本性，思考问题不同的解决方式，尝试看透问题的本质。找到这些历久弥新、持久不变的底层原理、方法论，例如微服务架构的演进方向是 CAP 定理的权衡选择，局限于时间与空间法则。再看容器、服务网格、Cilium、Calico，它们的基本技术和底层原理也没什么变化，只是把不同的计算机基本原理、方法重新组合起来，换种形式去解决因为业务变化带来的新问题。
