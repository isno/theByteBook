...
时代的浪潮并不以人的意志为转移，剧烈变化的背景下，如果我们只专注于手头的工作，不抬头看天，过度关注于某个技术深度和细节，大革命来临的时候，之前关注的细节可能再也没有意义。
...
- 需要构建高可用和健壮运行的系统。
- 对请求响应式系统（Web）如何运行有着天然的兴趣和探索精神。

## 如何阅读本书

本书参考当前技术趋势，结合落地实践总共分为十章，整体内容脉络从架构外部（用户端网络）逐渐延伸至架构内部（内核网络、虚拟网络、负载均衡、分布式、质量观测、GitOps交付等），最终，所有的问题、理论均导向落地。

以下为各章内容简介：

- 第一章**从需求的背景、发展的历史开始，漫谈微服务、容器、不可变基础设施、声明式设计、服务网格、DevOps 等云原生技术**。从解决问题的角度理解这些技术，借历史之名审视今天的现实问题，以及思考未来的技术/架构演进之路。
...
本书参考了大量他人的思想，得益于互联网开源免费，笔者有幸将这些知识融合和系统化。

其参考的著作、演讲、论文与我而言是宝贵的学习资源，已尽量在章节总结或者内容脚注。

最后感谢我的爱人，承担起照顾两个孩子的责任，能忍受我在工作之余将时间用在写作上，没有她的支持我无法完成写作。
