...
所以，本书很少详细描述某个软件如何安装、如何使用，而是**尝试从它们解决问题的角度出发，思考问题本质以及不同的解决方式，找到些许核心原理以及悟透点发展规律**。例如分布式系统演进方向是 CAP 定理的权衡选择，局限在于时间与空间法则。再如容器、服务网格、Cilium、Calico，也不是什么黑科技，只是把不同的计算机基本原理、方法重新组合起来，换种形式去解决因为业务变化带来的新问题。
