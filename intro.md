...
文中列出了被重塑的产业，包括：最大的书店——Amazon（亚马逊）、最多人订阅的视频服——Netflix（网飞）、最大的音乐公司——iTunes 等等。

文章虽然于 2011 年发表，但是2023 年我们再回过头来看互联网对我们生活的冲击，感触更加深刻，软件已经如水、电、媒一样，与我们的生活息息相关。

## 移动互联网在加剧变化

 Mark Andreessen 在文章中展望互联网规模时，写道「在接下来的 10 年里，我预计全球至少有 50 亿人拥有智能手机，每个人每天都可以随时随地使用手机充分利用互联网」。

现在，我们已经可以确认他的预测很正确，移动互联网时代的用户规模已经开始向人口基数看齐，开始出现各类亿级 DAU 规模的移动应用。那么移动互联网如此巨大的用户规模会对软件开发有什么影响？援引 Netflix 分享中的一则总结，如图所示。
