...
这次故障实际上是 Facebook BGP 路由系统和 DNS 系统一系列设计缺陷叠加，而从放大了故障影响：
...
一些运维操作具有很大风险性。例如，更改 BGP 通告、修改路由、修改防火墙策略等，这类的操作如果产生失误，有可能造成远程连接无法再使用，再想远程修复就难了，只能接近物理机才能处理。
