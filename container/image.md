...
伴随云原生理念、Kubernetes 等技术的普及，无论大中小企业基本都开始对容器化技术进行了不同程度的尝试，而这一切的推进的开始，不可避免的的技术便是容器镜像构建。

容器镜像的设计非常出彩，首先它蕴含了“完整操作系统就是一个包”的设计思想，带着大家跳出了安装包的思路，又提出了诸如 dockerfile 这样提升开发者体验的杀手级特性。
