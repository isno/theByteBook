...
```
注意 Mi（Mebibyte，2 的 20 次方，即 1,048,576）和 M（Megabyte，表示 10 的 6 次方，即 1,000,000）的区分，123 Mi = `123*1024*1024 B` 、123 M = `1*1000*1000 B`。随着数值的增加，Mi 和 M 计算的差异会越来越大，因此使用带小 i 的更准确。
