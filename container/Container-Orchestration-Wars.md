...
故事让内容变得有趣，**在容器技术变革的浪潮中，曾发生过一场”史诗大战“，业界称之为 ”容器编排之争（Container Orchestration Wars）“**。本篇我们回顾这段历史，从宏观角度去观察 Kubernetes 的诞生与演变的驱动力，在当时或许认为是偶然的事件，站在尘埃落地的今天看起来却又全是必然。
