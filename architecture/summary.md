...
从 2015 年 CNCF（Cloud Native Computing Foundation，云原生计算基金会）成立至今，云原生技术历经八年的高速发展从初期的概念性讨论到 各类运行时、Istio、Knative 等等一系列 CNCF 孵化的项目逐渐毕业，围绕着 Kubernetes 诞生了丰富的上层应用和生态，更是让 Service Mesh、Serverless 这些革新云技术思想，真正进入了解决生产中的各类问题，可落地实施的阶段。
