...
Intel 创始人之一 Gordon Earle Moore 曾提出非常有名的摩尔定律，简而言之“每隔18个月，芯片的性能会增加一倍”。

随着虚拟化技术的出现，我们得以更高效地利用由硬件性能提升带来的丰富资源，这一技术不仅优化了资源分配，还显著降低了企业在IT基础设施上的投资成本。
...
这一时期，云计算的重要里程碑之一是 2001 年 VMware 发布了第一个针对 x86 服务器的虚拟化产品 —— VMware ESX。

使用 VMware ESX 之后，可以在一台物理机器上运行多个虚拟机，如果业务需要扩容，那就在线再开通一个虚拟机。
...
事实上，虽然 2006 年业内就提出了“云计算”的概念，但直到 2008 年，整个行业才迎来了爆发式的发展，国内云计算标杆阿里云也是从 2008 年开始筹办和起步。

从这以后开始，云计算正式成为计算机领域最令人关注的话题之一，同时也成为互联网公司研究及发展的重要方向。
...
从此云计算不再是仅提供计算、存储、网络资源初级阶段，而是进阶到能提供强大的软件交付/维护等能力的服务平台。

从虚拟机到容器，整个云计算市场发生了一次重大变革，甚至是洗牌，基于容器技术的容器编排市场，则经历了 Mesos、Swarm、Kubernetes 三家的一场史诗大战。因声明式设计、充分开放的架构以及先进的设计思想，最终 Kubernetes 全面胜利，成为容器编排领域的事实标准。
...
图 1-5 形象地概述了这二十年云计算的演进过程，从物理机到虚拟机到容器，从 IaaS 诞生到 PaaS、FaaS 一路演进，应用的构建和部署变的越来越轻、越来越快，而底层基础设施和平台则越来越强大，以不同形态的云对上层应用提供强力支撑。
